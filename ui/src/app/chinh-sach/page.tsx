        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {policies.map((p, idx) => {
            return (
              ...
              >
                <div>
                  <div className="w-14 h-14 rounded-2xl bg-[#c88922]/15 border border-[#c88922]/30 flex items-center justify-center text-[#ffe2a0] mb-6 group-hover:bg-[#c88922] group-hover:text-[#151008] transition-colors text-2xl">
                ...
                <div className="inline-flex items-center gap-2 text-xs font-bold font-philosopher text-[#c88922] group-hover:text-[#ffe2a0] tracking-wider uppercase">
                  ...
                  <i className="fa fa-arrow-right text-xs group-hover:translate-x-1 transition-transform" />
                </div>
              </Link>
            );
          })}
