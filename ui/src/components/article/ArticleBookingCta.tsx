...
import { Phone, Sparkles, CalendarCheck } from "lucide-react";
      ...
      <div className="relative overflow-hidden rounded-3xl border border-[#c88922]/40 bg-gradient-to-br from-[#24170d] via-[#16100a] to-[#0d0905] p-6 md:p-10 my-12 shadow-2xl">
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#c88922]/20 border border-[#c88922]/40 text-[#ffe2a0] text-xs font-bold font-philosopher uppercase tracking-wider mb-4">
            <Sparkles className="w-3.5 h-3.5 text-[#c88922]" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
            ...
            <a
              href="tel:02435332266"
              className="w-full sm:w-auto px-6 py-3.5 rounded-full bg-[#1c140d] border border-[#c88922]/40 text-[#ffe2a0] hover:border-[#c88922] hover:text-[#ffffff] font-bold font-philosopher uppercase text-xs md:text-sm tracking-wider transition-all duration-200 flex items-center justify-center gap-2"
            >
